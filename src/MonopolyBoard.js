...
const MonopolyBoard = () => {
        ...
        const calculateNewPosition = (currentPosition, diceRoll) => {
                ...
                const newPosition = (currentPosition + diceRoll) % totalSpaces;
                return newPosition === 0 ? totalSpaces : newPosition;
        };

        const rollDice = () => {
                if (!isDiceRolled) {
                        const diceRoll = Math.floor(Math.random() * 6) + 1;
                        const newPosition = calculateNewPosition(playerPosition, diceRoll);
            ...
            <div className="table">
                    <div className="board">
                            ...
                            <div className="space corner go">
                                    ...
                                    {/* Render player token when dice is rolled */}
                                    {isDiceRolled && (
                                        <div className={`player-token yellow-circle position-${playerPosition}`}></div>
                                    )}
                            </div>
